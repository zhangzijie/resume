    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-9 col-md-10">
                <h3 class="sub-header">修改求职者信息</h3>
                <form class="form-horizontal" id="jobseeker-form" action="updateJobseeker" method="post">
                    <input type="hidden" id="id" name="id" value="${jobseekeritem.id}">
                    ...
                    <legend><a name="fullname"></a>个人信息<span style="color: red;">*</span></legend>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">姓名</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="fullname" name="fullname" value="${jobseekeritem.fullname}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">联系电话</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="phone" name="phone" value="${jobseekeritem.phone}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">电子邮箱</label>
                        <div class="col-sm-5">
                            <input type="email" class="form-control" id="email" name="email" value="${jobseekeritem.email}" required>
                        </div>
                    </div>
